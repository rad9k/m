...
{
    /// <summary>
    /// Aggregated performance logging for UX diagram hot paths.
    /// Flushes a summary every FlushIntervalMs to avoid flooding the log on mouse moves.
    /// Disable with UXPerfLog.Enabled = false when finished measuring.
    /// </summary>
    public static class UXPerfLog
    {
        public static bool Enabled = true;

        public static int FlushIntervalMs = 500;

        const string Where = "UXPerf";
