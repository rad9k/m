    ...
    public class LegacySystem_MinusZero : IStoreUniverse, IDisposable
    {
        ...
        void CreateSystemMetaBase_Part1()
        {
            ...
            //
             ...
             LegacySystem.Graph.EasyVertex.Get(sm, false, @"Base\Vertex\$Inherit").AddEdge(
                LegacySystem.Graph.EasyVertex.Get(sm, false, @"*$EdgeTarget"),
               LegacySystem.Graph.EasyVertex.Get(sm, false, @"Base\Vertex"));
        ...
        void CreateSystemFormalTextLanguegeZeroCode_Keywords()
        {
            ...
            _inherits.AddVertex(LegacySystem.Graph.EasyVertex.Get(smb, false, @"Vertex\$Inherit"), "(?<link>)");

            //_inherits.AddVertex(LegacySystem.Graph.EasyVertex.Get(smb, false, @"Vertex\$Description"), "(?<link>)");
        ...
        void CreateSystemMetaZeroTypes_UX_Additional()
        {
            ...
            m0.LegacySystem.Util.GeneralUtil.ParseAndExcute(smzu, sm, "{" +
                ...
                "Enum:LineEndEnum{EnumValue:Straight,EnumValue:Arrow,EnumValue:Triangle,EnumValue:FilledTriangle,EnumValue:Diamond,EnumValue:FilledDiamond,EnumValue:CrowFoot}," +
                ...
                "Class:CodeView{Attribute:ContentQuery{$MinCardinality:0,$MaxCardinality:1},Attribute:FontSize{$MinCardinality:1,$MaxCardinality:1,$DefaultValue:14,MinValue:1,MaxValue:40,$DisplayLarger:},Association:FormalTextLanguageProcessing{$MinCardinality:1,$MaxCardinality:1}}" +
                "}");
            ...
            smzu.Get(false, @"LabeledItem\ShowIcons").AddEdge(sm.Get(false, @"?$EdgeTarget"), sm.Get(false, @"ZeroTypes\Boolean"));
        ...
        void CreateSystemMetaVisualiser()
        {
            ...
            m0.LegacySystem.Util.GeneralUtil.ParseAndExcute(smv, sm, "{Enum:BaseEdgeTarget{EnumValue:Any,EnumValue:Specyfic}," +
                ...
                "Class:Tree{Attribute:ShowIcons{$MinCardinality:1,$MaxCardinality:1,$DefaultValue:True}}," +
                "Class:Graph{Attribute:VisualiserCircleSize{$MinCardinality:1,$MaxCardinality:1},Attribute:NumberOfCircles{$MinCardinality:1,$MaxCardinality:1,$UpdateAfterInteractionEnd:},Attribute:ShowOutEdges{$MinCardinality:1,$MaxCardinality:1,$DefaultValue:True},Attribute:ShowInEdges{$MinCardinality:1,$MaxCardinality:1},Attribute:FastMode{$MinCardinality:1,$MaxCardinality:1},Attribute:MetaLabels{$MinCardinality:1,$MaxCardinality:1},Attribute:AnimateEdges{$MinCardinality:1,$MaxCardinality:1,$DefaultValue:False},Attribute:ShowIcons{$MinCardinality:1,$MaxCardinality:1,$DefaultValue:True}}," +
                "Class:Graph3D{Attribute:EdgeLength{$MinCardinality:1,$MaxCardinality:1},Attribute:SphereSize{$MinCardinality:1,$MaxCardinality:1,MinValue:4,MaxValue:150,$DefaultValue:24},Attribute:LabelSize{$MinCardinality:1,$MaxCardinality:1},Attribute:ShowOutEdges{$MinCardinality:1,$MaxCardinality:1,$DefaultValue:True},Attribute:ShowInEdges{$MinCardinality:1,$MaxCardinality:1},Attribute:MetaLabels{$MinCardinality:1,$MaxCardinality:1},Attribute:ShowLabels3D{$MinCardinality:1,$MaxCardinality:1,$DefaultValue:True},Attribute:NumberOfCircles{$MinCardinality:1,$MaxCardinality:1,$UpdateAfterInteractionEnd:},Attribute:MaxVertices3D{$MinCardinality:1,$MaxCardinality:1,$UpdateAfterInteractionEnd:,MinValue:10,MaxValue:1000,$DefaultValue:250},Attribute:LayoutMode3D{$MinCardinality:1,$MaxCardinality:1},Attribute:IconsOnVertexes{$MinCardinality:1,$MaxCardinality:1,$DefaultValue:True},Attribute:IconsOnLabels{$MinCardinality:1,$MaxCardinality:1,$DefaultValue:True},Attribute:TransitionStyle{$MinCardinality:1,$MaxCardinality:1},Attribute:TransitionDurationMs{$MinCardinality:1,$MaxCardinality:1,MinValue:50,MaxValue:3000,$DefaultValue:1000},Attribute:AnimateEdges{$MinCardinality:1,$MaxCardinality:1,$DefaultValue:True}}," +
                ...
                "Class:Wrap," +
                "Class:Icon{Attribute:IconSize{$MinCardinality:1,$MaxCardinality:1,$DefaultValue:64,MinValue:16,MaxValue:256}}," +
                "Class:List{Attribute:IsMetaRightAlign{$MinCardinality:1,$MaxCardinality:1},Attribute:IsAllVisualisersEdit{$MinCardinality:1,$MaxCardinality:1},Attribute:ShowMeta{$MinCardinality:1,$MaxCardinality:1,$DefaultValue:True},Association:GridStyle{$MinCardinality:1,$MaxCardinality:1},Attribute:ShowIcons{$MinCardinality:1,$MaxCardinality:1,$DefaultValue:True},Attribute:ShowHeader{$MinCardinality:1,$MaxCardinality:1,$DefaultValue:True}}," +
                "Class:InEdgesList{Attribute:IsMetaRightAlign{$MinCardinality:1,$MaxCardinality:1},Attribute:ShowMeta{$MinCardinality:1,$MaxCardinality:1,$DefaultValue:True},Association:GridStyle{$MinCardinality:1,$MaxCardinality:1},Attribute:ShowIcons{$MinCardinality:1,$MaxCardinality:1,$DefaultValue:True},Attribute:ShowHeader{$MinCardinality:1,$MaxCardinality:1,$DefaultValue:True}}," +
            ...
            sm.Get(false, @"Visualiser\RepositionAlgorithmEnum").AddEdge(sm.Get(false, "?$Inherits"), sm.Get(false, @"ZeroTypes\EnumBase"));
            sm.Get(false, @"Visualiser\LayoutAlgorithm3DEnum").AddEdge(sm.Get(false, "?$Inherits"), sm.Get(false, @"ZeroTypes\EnumBase"));
            sm.Get(false, @"Visualiser\TransitionStyle3DEnum").AddEdge(sm.Get(false, "?$Inherits"), sm.Get(false, @"ZeroTypes\EnumBase"));
            ...
            sm.Get(false, @"Visualiser\Code").AddEdge(sm.Get(false, "?$Inherits"), sm.Get(false, @"Visualiser\ShowesOutEdges"));
            ...
            sm.Get(false, @"Visualiser\Icon").AddEdge(sm.Get(false, "?$Inherits"), sm.Get(false, @"ZeroTypes\UX\UXItem"));
            sm.Get(false, @"Visualiser\Icon").AddEdge(sm.Get(false, "?$Inherits"), sm.Get(false, @"Visualiser\ShowesOutEdges"));
            sm.Get(false, @"Visualiser\Icon").AddEdge(sm.Get(false, "?$Inherits"), sm.Get(false, @"ZeroTypes\HasSelectedEdges"));
            sm.Get(false, @"Visualiser\Icon").AddVertex(sm.Get(false, "?$PlatformClassName"), @"m0.UIWpf.Visualisers.IconVisualiser, m0_desktop, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null");
            sm.Get(false, @"Visualiser\Icon").AddEdge(sm.Get(false, @"?$Is"), sm.Get(false, @"ZeroUML\Class"));
            sm.Get(false, @"Visualiser\Icon\IconSize").AddEdge(sm.Get(false, @"?$EdgeTarget"), sm.Get(false, @"ZeroTypes\Integer"));
            sm.Get(false, @"Visualiser\Icon").AddEdge(sm.Get(false, @"Visualiser\BaseEdgeTarget"), sm.Get(false, @"Visualiser\BaseEdgeTarget\Any"));

            sm.Get(false, @"Visualiser\List").AddEdge(sm.Get(false, "?$Inherits"), sm.Get(false, @"ZeroTypes\UX\UXItem"));
            sm.Get(false, @"Visualiser\List").AddEdge(sm.Get(false, "?$Inherits"), sm.Get(false, @"Visualiser\ShowesOutEdges"));
            ...
            sm.Get(false, @"Visualiser\List\ShowIcons").AddEdge(sm.Get(false, @"?$EdgeTarget"), sm.Get(false, @"ZeroTypes\Boolean"));
            ...
            sm.Get(false, @"Visualiser\InEdgesList").AddEdge(sm.Get(false, @"?$Is"), sm.Get(false, @"ZeroUML\Class"));
            sm.Get(false, @"Visualiser\InEdgesList\ShowMeta").AddEdge(sm.Get(false, @"?$EdgeTarget"), sm.Get(false, @"ZeroTypes\Boolean"));
            sm.Get(false, @"Visualiser\InEdgesList\GridStyle").AddEdge(sm.Get(false, @"?$EdgeTarget"), sm.Get(false, @"Visualiser\GridStyleEnum"));
            sm.Get(false, @"Visualiser\InEdgesList\IsMetaRightAlign").AddEdge(sm.Get(false, @"?$EdgeTarget"), sm.Get(false, @"ZeroTypes\Boolean"));            
            sm.Get(false, @"Visualiser\InEdgesList\ShowIcons").AddEdge(sm.Get(false, @"?$EdgeTarget"), sm.Get(false, @"ZeroTypes\Boolean"));
            sm.Get(false, @"Visualiser\InEdgesList\ShowHeader").AddEdge(sm.Get(false, @"?$EdgeTarget"), sm.Get(false, @"ZeroTypes\Boolean"));
            sm.Get(false, @"Visualiser\InEdgesList").AddEdge(sm.Get(false, @"Visualiser\BaseEdgeTarget"), sm.Get(false, @"Visualiser\BaseEdgeTarget\Any"));

            sm.Get(false, @"Visualiser\Table").AddEdge(sm.Get(false, "?$Inherits"), sm.Get(false, @"ZeroTypes\UX\UXItem"));
            sm.Get(false, @"Visualiser\Table").AddEdge(sm.Get(false, "?$Inherits"), sm.Get(false, @"Visualiser\ShowesOutEdges"));
            ...
            sm.Get(false, @"Visualiser\TableFast").AddEdge(sm.Get(false, "?$Inherits"), sm.Get(false, @"Visualiser\ShowesOutEdges"));
            ...
            sm.Get(false, @"Visualiser\Tree").AddEdge(sm.Get(false, "?$Inherits"), sm.Get(false, @"Visualiser\ShowesOutEdges"));
            ...
            sm.Get(false, @"Visualiser\Graph").AddEdge(sm.Get(false, "?$Inherits"), sm.Get(false, @"Visualiser\ShowesOutEdges"));
            ...
            sm.Get(false, @"Visualiser\Graph\AnimateEdges").AddEdge(sm.Get(false, @"?$EdgeTarget"), sm.Get(false, @"ZeroTypes\Boolean"));
            sm.Get(false, @"Visualiser\Graph\ShowIcons").AddEdge(sm.Get(false, @"?$EdgeTarget"), sm.Get(false, @"ZeroTypes\Boolean"));
            ...
            sm.Get(false, @"Visualiser\Graph3D").AddEdge(sm.Get(false, "?$Inherits"), sm.Get(false, @"Visualiser\ShowesOutEdges"));
            ...
            sm.Get(false, @"Visualiser\Graph3D\IconsOnVertexes").AddEdge(sm.Get(false, @"?$EdgeTarget"), sm.Get(false, @"ZeroTypes\Boolean"));
            sm.Get(false, @"Visualiser\Graph3D\IconsOnLabels").AddEdge(sm.Get(false, @"?$EdgeTarget"), sm.Get(false, @"ZeroTypes\Boolean"));
            sm.Get(false, @"Visualiser\Graph3D\AnimateEdges").AddEdge(sm.Get(false, @"?$EdgeTarget"), sm.Get(false, @"ZeroTypes\Boolean"));
            ...
            sm.Get(false, @"Visualiser\Class").AddEdge(sm.Get(false, "?$Inherits"), sm.Get(false, @"Visualiser\ShowesOutEdges"));
            ...
            sm.Get(false, @"Visualiser\String").AddEdge(sm.Get(false, "?$Inherits"), sm.Get(false, @"Visualiser\ShowesOutEdges"));
            ...
            sm.Get(false, @"Visualiser\Debug").AddEdge(sm.Get(false, "?$Inherits"), sm.Get(false, @"Visualiser\ShowesOutEdges"));
        ...
        void CreateSystemMetaVisualiser_Additional()
        {
            ...
            IVertex UXContainer = sm.Get(false, @"ZeroTypes\UX\UXContainer");
            IVertex UXContainer_Reposition = AddMethod(UXContainer, "Reposition", UXVisualiserTypeString, "Reposition", null, new TypeName[] { new TypeName("Algorithm", RepositionAlgorithmEnum, 1, 1) });
        }
        ...
        void CreateSystemMetaMethodVisualiser()
        {
            ...
            sm.Get(false, @"Visualiser\Method\VoidAnyMethod").AddVertex(sm.Get(false, "?$PlatformClassName"), @"m0.UIWpf.Visualisers.Method.VoidAnyMethod, m0_desktop, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null");
            sm.Get(false, @"Visualiser\Method\VoidAnyMethod").AddEdge(sm.Get(false, @"?$Is"), sm.Get(false, @"ZeroUML\Class"));
        }
       ...
       -1, 0, 0, 100);
        ...
        void CreateUserMeta()
        {
            ...
            m0.LegacySystem.Util.GeneralUtil.ParseAndExcute(smzt, sm, "{User{CurrentUser," +
                ...
                "Class:Settings{Attribute:CopyOnDragAndDrop{$MinCardinality:1,$MaxCardinality:1},Association:AllowBlankAreaDragAndDrop{$MinCardinality:1,$MaxCardinality:1},Attribute:AllowManyUXItemsWithSameBaseEdgeTo{$MinCardinality:1,$MaxCardinality:1},Attribute:AutogenerateDiagramImages{$MinCardinality:1,$MaxCardinality:1},Attribute:MetaIconsDirectoryName},Enum:AllowBlankAreaDragAndDropEnum{EnumValue:No,EnumValue:OnlyEnd,EnumValue:StartAndEnd}," +
            ...
            smzt.Get(false, @"User\Settings\MetaIconsDirectoryName").AddEdge(sm.Get(false, @"?$EdgeTarget"), sm.Get(false, @"ZeroTypes\String"));            
        }
        ...
        void CreateSystemDataUXZeroUMLTemplate()
        {
            ...
            GraphUtil.LoadTXTParseAndMove(@"_RES\UXTemplate\SQL.txt",
                sdut,
                "SQL");
        }
        ...
        void CreateSystemMetaCustomDomain()
        {
            ...
            IVertex smc = sm.AddVertex(null, "CustomDomain");

            GraphUtil.LoadTXTParseAndMove(@"_RES\CustomDomain\SQL.txt",
                smc,
                "SQL");
        }
        ...
        void CreateSystemFormalTextLanguageZeroCodeVisual_ViewTokens()
        {
            ...
            string[] operators =
            {
                "<<copy<<", "<<move<<", "<<copy&replace<<", "<<move&replace<<", "#", "<>", "<+>", "<->", "<-", "+<", "=", "+=", "~=", "-<", "~<", "<-", "<<", ">>", "~00", "+", "-", "*", "/", "==", "===", "====", "!=", "!", "&", "|", ">=", "<=", "::", ":", "%", "`", "[", "]", "(", ")", "\\", "?", "{", "}", ".", ",", "<", ">"
                //	\#|&lt;&gt;|&lt;\+&gt;|&lt;-&gt;|&lt;-|\+&lt;|=|\+=|~=|-&lt;|~&lt;|&lt;-|&lt;\+&lt;|&lt;&lt;&lt;|&lt;&lt;|&gt;&gt;|~00|\+|-|\*|/|==|===|====|!=|!|\&amp;|\||&gt;=|&lt;=|::|:|%|`|\[|\]|\(|\)|\\|\?|\{|\}|\.|,|\+&lt;|&lt;|&gt;
            };
