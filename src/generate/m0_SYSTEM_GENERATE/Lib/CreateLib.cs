...
namespace m0_SYSTEM_GENERATE.Lib
{
    public class CreateLib
    {
        ...
        public static void CreateLibSys()
        {
            ...
            IVertex PlatformTypeEnum = GraphUtil.AddEnum(LibSys, "PlatformTypeEnum", new String[] { "Console", "Desktop", "Browser" });

            AddFunction(LibSys, "SleepUntilGracefullExit", type, "SleepUntilGracefullExit", null, new TypeName[] { });
            AddFunction_VertexAsReturnType(LibSys, "GetPlatformType", type, "GetPlatformType", PlatformTypeEnum, new TypeName[] { });
        ...
        public static void CreateLibStdView()
        {
            ...
            IVertex ReplaceSpaceAndSpecialCharacters_Vertex = LibStdView.Get(false, @"Html\ReplaceSpaceAndSpecialCharacters");
            ...
            ExecutionFlowHelper.DecorateWithDotNetStaticMethod(ReplaceSpaceAndSpecialCharacters_Vertex,
                "m0.Lib.StdView.Html, m0, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null",
                "ReplaceSpaceAndSpecialCharacters");            
        }        
