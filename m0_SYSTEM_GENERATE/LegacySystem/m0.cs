...
namespace m0
{
    public class LegacySystem_MinusZero : IStoreUniverse, IDisposable
    {
        ...
        void CreateSystemMetaVisualiser()
        {
            ...
            sm.Get(false, @"Visualiser\").AddEdge(sm.Get(false, @"Visualiser\BaseEdgeTarget"), sm.Get(false, @"Visualiser\BaseEdgeTarget\Specyfic"));
            ...
            sm.Get(false, @"Visualiser\Sequence\ZoomVisualiserContent").AddEdge(sm.Get(false, @"?$EdgeTarget"), sm.Get(false, @"ZeroTypes\Integer"));
            sm.Get(false, @"Visualiser\Sequence\ZoomVisualiserContent").AddVertex(sm.Get(false, @"?MinValue"), 0);
            sm.Get(false, @"Visualiser\Sequence\ZoomVisualiserContent").AddVertex(sm.Get(false, @"?MaxValue"), 200);
