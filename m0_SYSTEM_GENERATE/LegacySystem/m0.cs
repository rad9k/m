    ...
    public class LegacySystem_MinusZero : IStoreUniverse, IDisposable
    {
        ...
        void CreateSystemMetaVisualiser()
        {
            ...
            m0.LegacySystem.Util.GeneralUtil.ParseAndExcute(smv, sm, "{Enum:BaseEdgeTarget{EnumValue:Any,EnumValue:Specyfic},"+
                ...
                "Class:Set2D{Attribute:ShowArrowLines{$MinCardinality:1,$MaxCardinality:1,$DefaultValue:True},Attribute:ShowLabel{$MinCardinality:1,$MaxCardinality:1,$DefaultValue:False},Attribute:VerticalAxisMax{$MinCardinality:1,$MaxCardinality:1},Attribute:VerticalAxisMin{$MinCardinality:1,$MaxCardinality:1},Attribute:HorizontalAxisMin{$MinCardinality:1,$MaxCardinality:1},Attribute:HorizontalAxisMax{$MinCardinality:1,$MaxCardinality:1}}," +
            ...
            sm.Get(false, @"Visualiser\Set2D\ShowLabel").AddEdge(sm.Get(false, @"?$EdgeTarget"), sm.Get(false, @"?Boolean"));
