...
Multiple instance types support different workflows: console instances for Linux/Mac/Docker environments, and GUI instances (Windows WPF) providing unified drag-and-drop, bulk operations, and advanced editors where all GUI elements are themselves manipulable graph fragments. Built-in libraries support REST endpoint exposure and consumption, HTTP/Markdown web server, and JSON processing—enabling graph-based web services and document publishing.
