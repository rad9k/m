...
namespace m0.Store.Json
{
    public class JsonSerializationData
    {
        ...
        public List<JsonVertex> Vertices { get; set; } = new List<JsonVertex>();
    }
    ...
    public class JsonVertex
    {
        ...
        // Helper methods to handle union types - używane do czytania/pisania
        public void SetId(object value)
        {
            if (value is string str)
                Id = JsonSerializer.SerializeToElement(str);
            else if (value is long lng)
                Id = JsonSerializer.SerializeToElement(lng);
        }
        ...
        {
            if (value is string str)
                Value = JsonSerializer.SerializeToElement(str);
            else if (value is int intVal)
                Value = JsonSerializer.SerializeToElement(intVal);
        }
        ...
        {
            get => Id.ValueKind == JsonValueKind.String ? Id.GetString() : null;
            set { if (value != null) Id = JsonSerializer.SerializeToElement(value); }
        }

        [JsonIgnore]
        public long? IdLong
        {
            get => Id.ValueKind == JsonValueKind.Number ? Id.GetInt64() : null;
            set { if (value.HasValue) Id = JsonSerializer.SerializeToElement(value.Value); }
        }

        [JsonIgnore]
        public string ValueString
        {
            get => Value.ValueKind == JsonValueKind.String ? Value.GetString() : null;
            set { if (value != null) Value = JsonSerializer.SerializeToElement(value); }
        }

        [JsonIgnore]
        public int? ValueInt
        {
            get => Value.ValueKind == JsonValueKind.Number && Value.TryGetInt32(out int val) ? val : null;
            set { if (value.HasValue) Value = JsonSerializer.SerializeToElement(value.Value); }
        }
    }
    ...
    public class JsonEdge
    {
        ...
        public JsonElement MetaId { get; set; }

        public int ToStoreId { get; set; }

        [JsonPropertyName("ToId")]
        public JsonElement ToId { get; set; }

        // Helper methods to handle union types
        public void SetMetaId(object value)
        {
            if (value is string str)
                MetaId = JsonSerializer.SerializeToElement(str);
            else if (value is long lng)
                MetaId = JsonSerializer.SerializeToElement(lng);
        }

        public object GetMetaId()
        {
            if (MetaId.ValueKind == JsonValueKind.String)
                return MetaId.GetString();
            else if (MetaId.ValueKind == JsonValueKind.Number)
                return MetaId.GetInt64();
            return null;
        }

        public void SetToId(object value)
        {
            if (value is string str)
                ToId = JsonSerializer.SerializeToElement(str);
            else if (value is long lng)
                ToId = JsonSerializer.SerializeToElement(lng);
        }

        public object GetToId()
        {
            if (ToId.ValueKind == JsonValueKind.String)
                return ToId.GetString();
            else if (ToId.ValueKind == JsonValueKind.Number)
                return ToId.GetInt64();
            return null;
        }
        ...
        {
            get => MetaId.ValueKind == JsonValueKind.String ? MetaId.GetString() : null;
            set { if (value != null) MetaId = JsonSerializer.SerializeToElement(value); }
        }

        [JsonIgnore]
        public long? MetaIdLong
        {
            get => MetaId.ValueKind == JsonValueKind.Number ? MetaId.GetInt64() : null;
            set { if (value.HasValue) MetaId = JsonSerializer.SerializeToElement(value.Value); }
        }

        [JsonIgnore]
        public string ToIdString
        {
            get => ToId.ValueKind == JsonValueKind.String ? ToId.GetString() : null;
            set { if (value != null) ToId = JsonSerializer.SerializeToElement(value); }
        }

        [JsonIgnore]
        public long? ToIdLong
        {
            get => ToId.ValueKind == JsonValueKind.Number ? ToId.GetInt64() : null;
            set { if (value.HasValue) ToId = JsonSerializer.SerializeToElement(value.Value); }
        }
    }
    ...
    public class JsonSerializationStore : StoreBase
    {
        ...
        private void ReconstructVerticesFromSerialisationData(JsonSerializationData data)
        {
            ...
            foreach (JsonVertex jv in data.Vertices)
            {
                ...
                if (jv.IdString == null)
                {
                    toBeIdentifier = jv.IdLong.Value;
...
namespace m0.Store.Json
{
    public class JsonSerializationData
    {
        public Dictionary<int, StoreId> StoreIdDictionary { get; set; }
    ...
    public class JsonVertex
    {
        ...
        // Helper properties to handle unions
        [JsonIgnore]
        public string IdString
        {
            get => Id.ValueKind == JsonValueKind.String ? Id.GetString() : null;
            set => Id = JsonSerializer.SerializeToElement(value);
        }
        ...
        {
            get => Value.ValueKind == JsonValueKind.String ? Value.GetString() : null;
            set => Value = JsonSerializer.SerializeToElement(value);
        }

        [JsonIgnore]
        public int? ValueInt
        {
            get => Value.ValueKind == JsonValueKind.Number ? Value.GetInt32() : null;
            set => Value = JsonSerializer.SerializeToElement(value);
        }
    }
    ...
    public class JsonEdge
    {
        ...
        {
            get => MetaId.ValueKind == JsonValueKind.String ? MetaId.GetString() : null;
            set => MetaId = JsonSerializer.SerializeToElement(value);
        }
        ...
        {
            get => ToId.ValueKind == JsonValueKind.String ? ToId.GetString() : null;
            set => ToId = JsonSerializer.SerializeToElement(value);
        }
