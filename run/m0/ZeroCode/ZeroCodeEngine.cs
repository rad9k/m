...
namespace m0.ZeroCode
{
    ...
    {             
        ...
        public static IVertex Parse2(IVertex formalTextLanguage, IEdge rootEdge, string text, CodeRepresentationEnum codeRepresentation, out IEdge rootEdge_new)
        {
            rootEdge_new = null;
            return null;
        }

        public static string Generate2(IVertex formalTextLanguage, IEdge graphBaseEdge, CodeRepresentationEnum codeRepresentation)
        {
            return null;
        }
